...
; but it can be important to understand the behavioral and performance differences so that you know which
; kind is appropriate for your application.<br /><br />Write a function which takes a collection and
; returns one of :map, :set, :list, or :vector - describing the type of collection it was given.<br />
